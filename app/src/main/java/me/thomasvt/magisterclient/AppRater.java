...
public class AppRater {
    ...
    private static final String DEFAULT_TARGET_URI = "market://me.thomasvt.magisterclient";
    private static final String DEFAULT_TEXT_TITLE = "Waardeer deze app";
    private static final String DEFAULT_TEXT_EXPLANATION = "We zouden het erg leuk vinden als je de app waardeerd op Google Play, Bedankt voor je support!";
    private static final String DEFAULT_TEXT_NOW = "Waardeer";
    private static final String DEFAULT_TEXT_LATER = "Later";
    private static final String DEFAULT_TEXT_NEVER = "Nee bedankt";
